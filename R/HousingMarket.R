#' HousingData: U.S. Housing Market Trends (2012-2025)
#'
#' @description
#' This dataset tracks real estate market trends across multiple regions from 2012 to 2024, including metrics on home prices, sales activity, new listings, inventory, and market dynamics. It provides both absolute values and percentage changes to analyze short-term and long-term shifts in the housing market.
#'
