...
#'
#' @description
#' This data set tracks real estate market trends across multiple regions from 2012 to 2023, including metrics on home prices, sales activity, new listings, inventory, and market dynamics. It provides both absolute values and percentage changes to analyze short-term and long-term shifts in the housing market.
#'
#' @format A data frame with 785 observations and 38 variables
#' \describe{
