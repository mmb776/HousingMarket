...
#plot(lm2)
anova(AAInteraction)
overall_model <- lm(Average.Sale.To.List ~ `PopPct_BLACK OR AFRICAN AMERICAN ALONE`, data = HousingMarket)
#HousingMarket$overall_fit <- predict(overall_model, newdata = HousingMarket)
